...
Namespace CurationPoolApi
    ...
    Partial Public Class IntApi
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.SyncInvalidEmail.My.MySettings.Default.SyncInvalidEmail_CurationPoolApi_IntApi
        ...
        Public Function CreateContact_New(ByVal ConInfo As ContactInfo, ByRef strErrMsg As String) As String
            Dim results() As Object = Me.Invoke("CreateContact_New", New Object() {ConInfo, strErrMsg})
            strErrMsg = CType(results(1),String)
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub CreateContact_NewAsync(ByVal ConInfo As ContactInfo, ByVal strErrMsg As String)
            Me.CreateContact_NewAsync(ConInfo, strErrMsg, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub CreateContact_NewAsync(ByVal ConInfo As ContactInfo, ByVal strErrMsg As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("CreateContact_New", New Object() {ConInfo, strErrMsg}, Me.CreateContact_NewOperationCompleted, userState)
        End Sub
